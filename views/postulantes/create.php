...
<div class="postulante-page">
    ...
    <?php if (isset($_GET['duplicado'])): ?>
        <div class="error">
            Ya existe un postulante registrado con ese CI.
        </div>
    <?php endif; ?>
    ...
    <?php if (isset($_GET['nombre_repetido'])): ?>
        <div class="error">
            Ya existe un postulante con el mismo nombre completo, apellido paterno y apellido materno.
        </div>
    <?php endif; ?>
        ...
        <form action="../../controllers/PostulanteController.php?action=store" method="POST">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    <label>CI</label>
                    <input type="text" name="ci" value="<?php echo old('ci'); ?>" required>
                </div>

                <div class="form-group">
                    <label>Nombre completo</label>
                    <input type="text" name="nombre" value="<?php echo old('nombre'); ?>" required>
                </div>

                <div class="form-group">
                    <label>Apellido paterno</label>
                    <input type="text" name="apellido_paterno" value="<?php echo old('apellido_paterno'); ?>" required>
                </div>

                <div class="form-group">
                    <label>Apellido materno</label>
                    <input type="text" name="apellido_materno" value="<?php echo old('apellido_materno'); ?>" required>
                </div>

                <div class="form-group">
                    <label>Teléfono / Celular</label>
                    <input type="text" name="telefono" value="<?php echo old('telefono'); ?>">
                    <small>Opcional si registra correo. Obligatorio si no registra correo.</small>
                </div>

                <div class="form-group">
                    <label>Correo</label>
                    <input type="email" name="correo" value="<?php echo old('correo'); ?>">
                ...
                <div class="form-group">
                    ...
                    <select name="sexo">
                        ...
                        <option value="Masculino" <?php echo old('sexo') == 'Masculino' ? 'selected' : ''; ?>>Masculino</option>
                        <option value="Femenino" <?php echo old('sexo') == 'Femenino' ? 'selected' : ''; ?>>Femenino</option>
                    </select>
                </div>

                <div class="form-group">
                    <label>Ciudad</label>
                    <input type="text" name="ciudad" value="<?php echo old('ciudad'); ?>">
                </div>

                <div class="form-group">
                    <label>Dirección</label>
                    <input type="text" name="direccion" value="<?php echo old('direccion'); ?>">
                </div>

                <div class="form-group">
                    <label>Colegio de procedencia</label>
                    <input type="text" name="colegio_procedencia" value="<?php echo old('colegio_procedencia'); ?>">
                </div>

                <div class="form-group">
                    <label>Título de bachiller</label>
                    <input type="text" name="titulo_bachiller" value="<?php echo old('titulo_bachiller'); ?>">
                </div>
                    ...
                    <select name="id_carrera" id="id_carrera" required>
                        ...
                        <?php foreach ($carreras as $carrera): ?>
                            <option value="<?php echo $carrera['id_carrera']; ?>"
                                <?php echo old('id_carrera') == $carrera['id_carrera'] ? 'selected' : ''; ?>>
                ...
                <div class="form-group">
                    ...
                    <select name="id_carrera_segunda_opcion" id="id_carrera_segunda_opcion">
                        ...
                        <?php foreach ($carreras as $carrera): ?>
                            <option value="<?php echo $carrera['id_carrera']; ?>"
                                <?php echo old('id_carrera_segunda_opcion') == $carrera['id_carrera'] ? 'selected' : ''; ?>>
                                <?php echo htmlspecialchars($carrera['nombre_carrera']); ?>
                            </option>
                        <?php endforeach; ?>
                ...
                <div class="form-group full-row">
                    <label>Otros</label>
                    <textarea name="otros" rows="3"><?php echo old('otros'); ?></textarea>
                </div>
