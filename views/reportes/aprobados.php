...
<div class="reporte-page">
    ...
    <div class="reporte-header">
        <h1>Reporte de Aprobados</h1>
        <p>Listado de notas aprobadas por postulante y materia.</p>
    </div>

    <div class="acciones-superior">
        <a href="index.php" class="btn-volver">Volver a Reportes</a>
        <a href="exportar_csv.php?tipo=aprobados" class="btn-exportar">Exportar CSV</a>
    </div>
